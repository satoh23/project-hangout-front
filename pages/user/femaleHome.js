...
import { getAllUserData } from "../../lib/femaleUsers";
...
const apiUrl = `${process.env.NEXT_PUBLIC_RESTAPI_URL}api/v1/male-user-list/`;
...
export default function Home({ staticUsers }) {
    ...
    useEffect(() => {
        ...
        if (gender === `${process.env.NEXT_PUBLIC_MALE_ID}`) {
